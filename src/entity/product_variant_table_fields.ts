...
// This class defines the structure of your 'product_variant_table_fields' table in the database.
@Entity({ name: 'product_variant_table_fields' }) 
export class product_variant_table_fields_notinuse {
