...
// Define an interface for your cached application settings
 ...
 class User_tableService{
  ...
  private currentUsertableFields:Partial<User_table_fields>[] = [
    ...
    { FieldName: 'initialRoleName', FieldType: 'select', FieldLabel: 'Role',    IsRequired: true, SelectOptions: '[{"label":"DataEntry","value":"DataEntry"},{"label":"purchaserole","value":"purchaser"},{"label":"salesmanrole","value":"salesman"}]',  CreatedByMode: 'superadmin'      },
    { FieldName: 'initialRoleName', FieldType: 'select', FieldLabel: 'Role',    IsRequired: true, SelectOptions: '[{"label":"DataEntry","value":"DataEntry"},{"label":"purchaserole","value":"purchaser"},{"label":"salesmanrole","value":"salesman"}]',  CreatedByMode: 'signup'      },
